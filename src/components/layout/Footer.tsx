    ...
    <footer className="bg-neutral-900 text-neutral-300">
      ...
      <div className="bg-primary-700">
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="text-white font-heading font-bold text-xl">Ready to shop?</h3>
            <p className="text-primary-200 text-sm mt-0.5">Get in touch or browse our latest products</p>
          </div>
          <div className="flex gap-3">
            <a href={`https://wa.me/92${settings.whatsapp.replace(/^0/, '')}`} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium px-5 py-2.5 rounded-xl transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href={`https://wa.me/92${settings.whatsapp.replace(/^0/, '')}`} target="_blank" rel="noreferrer" className="flex items-center gap-2.5 text-sm hover:text-green-400 transition-colors">
              ...
              <li className="flex items-start gap-2.5 text-sm">
                <MapPin size={15} className="text-primary-400 shrink-0 mt-0.5" /> {settings.address}
              </li>
