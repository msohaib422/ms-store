...
export default function ProductCard({ product, index = 0 }: Props) {
  ...
  const finalPrice = hasVariants ? (firstVariant!.discountPrice || firstVariant!.price) : (product.discount_price || product.price);
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-end gap-2">
            ...
            {discount !== null && (
              <span className="text-sm text-neutral-400 line-through">Rs. {originalPrice.toLocaleString()}</span>
            )}
          </div>
