...
export default function AboutPage() {
  ...
  useEffect(() => {
    document.title = `About Us | ${settings.store_name}`;
  }, [settings]);
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative inline-block md:ml-32">
                ...
                <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl shadow-lg p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-heading font-bold text-neutral-900">Trusted Seller</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              ...
              <p className="text-neutral-600 leading-relaxed mb-4">
                Welcome to <strong>{settings.store_name}</strong>! I'm M. Sohaib, the founder and owner of this store. My mission is simple: to provide quality products at honest prices, with service you can trust.
              </p>
              <p className="text-neutral-600 leading-relaxed mb-6">
                I started this store with a passion for helping people find what they need without compromise. Every product in our store is carefully selected to ensure it meets our quality standards. Customer satisfaction is my top priority.
              </p>
      ...
      <section className="py-16 bg-neutral-50 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Shield, color: 'bg-primary-100 text-primary-600', title: 'Authenticity', desc: 'Every product is 100% genuine. No fakes, no compromises.' },
              { icon: Heart, color: 'bg-red-100 text-red-600', title: 'Customer First', desc: 'Your satisfaction is our highest priority, always.' },
              { icon: Award, color: 'bg-accent-100 text-accent-600', title: 'Quality', desc: 'We source only the best products for our customers.' },
              { icon: Users, color: 'bg-secondary-100 text-secondary-600', title: 'Community', desc: 'Building trust with our community one order at a time.' },
