                  ...
                  <motion.tr key={cat._id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="hover:bg-neutral-50">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        {cat.imageUrl ? <img src={cat.imageUrl} alt={cat.name} className="w-10 h-10 rounded-lg object-cover" /> : <div className="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center text-primary-600 font-bold">{cat.name[0]}</div>}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-1">
                        ...
                        <button onClick={() => del(cat._id)} className="p-1.5 rounded-lg hover:bg-red-50 text-neutral-400 hover:text-red-500"><Trash2 size={15} /></button>
                      </div>
                    </td>
                  </motion.tr>
                ))
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="number" {...register('displayOrder')} className="input" />
                </div>
                <div>
