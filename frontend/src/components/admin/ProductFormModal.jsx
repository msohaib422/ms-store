    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-start justify-center overflow-y-auto p-4">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8">
        <div className="flex items-center justify-between p-6 border-b border-neutral-200">
          ...
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-neutral-100"><X size={20} /></button>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea {...register('shortDescription')} rows={2} className="input resize-none" />
            </div>
            <div className="col-span-2">
            ...
            <div className="col-span-2">
              ...
              <input {...register('tags')} className="input" placeholder="e.g. sale, new, quality" />
            </div>
            <div className="col-span-2">
